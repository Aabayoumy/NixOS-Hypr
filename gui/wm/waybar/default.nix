      ...
      settings = [
        {
          ...
          wireplumber = {
            ...
            on-click = "eww open nix-volume";
            on-click-right = "eww close nix-volume";
          ...
          "custom/nix" = {
            ...
            tooltip = false;
            on-click = "eww open nix-poweroff && eww open nix-restart && eww open nix-logout";
            on-click-right = "eww close nix-poweroff && eww close nix-restart && eww close nix-logout";
          };
          "custom/music" = {
            format = "";
            tooltip = false;
